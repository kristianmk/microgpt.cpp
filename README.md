...
init (includes allocations)               2.71 ms
training                                 10.41 ms
inference                                 0.25 ms
total (init+train+infer)                 13.37 ms
train+infer (no init)                    10.66 ms
training per step                        10.41 us
inference per sample                     12.57 us
loss                              first=3.6024 last=2.8815 min=1.5387 avg=2.4559
```
